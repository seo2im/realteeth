...
export function DailyWeather({
  ...
  return (
    <div className="w-[calc(100vw-32px)] overflow-x-scroll md:w-full hide-scrollbar md:overflow-x-visible bg-white/20 backdrop-blur-md rounded-2xl md:rounded-3xl p-6 md:p-8 text-white shadow-xl">
